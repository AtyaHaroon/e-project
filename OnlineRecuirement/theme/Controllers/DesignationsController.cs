...
namespace theme.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] Designation designation)
        {
            if (ModelState.IsValid)
            {
